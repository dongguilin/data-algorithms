 ...
 * 驱动器类，定义输入/输出，并注册插件类（DateTemperaturePartitioner和DateTemperatureGroupingComparator）
 * 第一个比较器DateTemperaturePair.compareTo方法会控制键的排序顺序，第二个比较器DateTemperatureGroupingComparator.compare方法
 * 会控制哪些键要分组到一个reduce方法调用
 *
