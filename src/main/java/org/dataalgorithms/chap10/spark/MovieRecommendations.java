...
public class MovieRecommendations {
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            System.err.println("Usage: MovieRecommendations <input-path> <output-path>");
            System.exit(1);
        }
        ...
        JavaSparkContext ctx = SparkUtil.createJavaSparkContext("MovieRecommendations");
