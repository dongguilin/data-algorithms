...
public class FindAssociationRules {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("FindAssociationRules");
        ...
        // STEP-4: generate frequent patterns 生成频繁模式
        ...
        patterns.saveAsTextFile(output + "/rules/output/2");

        // STEP-5: combine/reduce frequent patterns  组合/归约频繁模式
        ...
        // STEP-6: generate all sub-patterns  生成所有子模式
        // PairFlatMapFunction<T, K, V>
        // T => Iterable<Tuple2<K, V>>
        ...
        // STEP-6: combine sub-patterns  组合子模式
        ...
        // STEP-7: generate association rules  生成关联规则
        ...
        assocRules.saveAsTextFile(output + "/rules/output/6");
